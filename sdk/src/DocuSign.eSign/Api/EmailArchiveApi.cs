...
namespace DocuSign.eSign.Api
{
    ...
    public partial class EmailArchiveApi : IEmailArchiveApi
    {
        ...
        /// </summary>
        /// <returns></returns>
        public EmailArchiveApi(String basePath)
        {
        ...
        /// <returns></returns>
        public EmailArchiveApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< BccEmailArchive > CreateBCCEmailArchiveWithHttpInfo (string accountId, BccEmailArchive bccEmailArchive = null)
        {
            ...
            {
                localVarPostBody = Configuration.ApiClient.Serialize(bccEmailArchive); // http body (model) parameter
            }
            else
            {
            ...
            {
                return new ApiResponse<BccEmailArchive>(localVarStatusCode, localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()), (BccEmailArchive) Configuration.ApiClient.Deserialize(localVarResponse.RawBytes, typeof(BccEmailArchive)));
            }
            else
            {
                return new ApiResponse<BccEmailArchive>(localVarStatusCode, localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()), (BccEmailArchive) Configuration.ApiClient.Deserialize(localVarResponse, typeof(BccEmailArchive)));
            }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<BccEmailArchive>> CreateBCCEmailArchiveAsyncWithHttpInfo (string accountId, BccEmailArchive bccEmailArchive = null)
        {
            ...
            return new ApiResponse<BccEmailArchive>(localVarStatusCode,
                ...
                (BccEmailArchive) Configuration.ApiClient.Deserialize(localVarResponse, typeof(BccEmailArchive)));
        ...
        public ApiResponse<Object> DeleteBCCEmailArchiveWithHttpInfo (string accountId, string bccEmailArchiveId)
        {
            ...
            localVarPathParams.Add("format", "json");
            if (accountId != null) localVarPathParams.Add("accountId", Configuration.ApiClient.ParameterToString(accountId)); // path parameter
            if (bccEmailArchiveId != null) localVarPathParams.Add("bccEmailArchiveId", Configuration.ApiClient.ParameterToString(bccEmailArchiveId)); // path parameter
        ...
        public ApiResponse< BccEmailArchiveHistoryList > GetBCCEmailArchiveHistoryListWithHttpInfo (string accountId, string bccEmailArchiveId, EmailArchiveApi.GetBCCEmailArchiveHistoryListOptions options = null)
        {
            ...
            if (localVarResponse.ContentType != null && !localVarResponse.ContentType.ToLower().Contains("json"))
            {
                return new ApiResponse<BccEmailArchiveHistoryList>(localVarStatusCode, localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()), (BccEmailArchiveHistoryList) Configuration.ApiClient.Deserialize(localVarResponse.RawBytes, typeof(BccEmailArchiveHistoryList)));
            }
            else
            {
                return new ApiResponse<BccEmailArchiveHistoryList>(localVarStatusCode, localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()), (BccEmailArchiveHistoryList) Configuration.ApiClient.Deserialize(localVarResponse, typeof(BccEmailArchiveHistoryList)));
            }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<BccEmailArchiveHistoryList>> GetBCCEmailArchiveHistoryListAsyncWithHttpInfo (string accountId, string bccEmailArchiveId, EmailArchiveApi.GetBCCEmailArchiveHistoryListOptions options = null)
        {
            ...
            return new ApiResponse<BccEmailArchiveHistoryList>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (BccEmailArchiveHistoryList) Configuration.ApiClient.Deserialize(localVarResponse, typeof(BccEmailArchiveHistoryList)));
        ...
        public ApiResponse< BccEmailArchiveList > GetBCCEmailArchiveListWithHttpInfo (string accountId, EmailArchiveApi.GetBCCEmailArchiveListOptions options = null)
        {
            ...
            if (localVarResponse.ContentType != null && !localVarResponse.ContentType.ToLower().Contains("json"))
            {
                return new ApiResponse<BccEmailArchiveList>(localVarStatusCode, localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()), (BccEmailArchiveList) Configuration.ApiClient.Deserialize(localVarResponse.RawBytes, typeof(BccEmailArchiveList)));
            }
            else
            {
                return new ApiResponse<BccEmailArchiveList>(localVarStatusCode, localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()), (BccEmailArchiveList) Configuration.ApiClient.Deserialize(localVarResponse, typeof(BccEmailArchiveList)));
            }
        ...
        public async System.Threading.Tasks.Task<ApiResponse<BccEmailArchiveList>> GetBCCEmailArchiveListAsyncWithHttpInfo (string accountId, EmailArchiveApi.GetBCCEmailArchiveListOptions options = null)
        {
            ...
            return new ApiResponse<BccEmailArchiveList>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (BccEmailArchiveList) Configuration.ApiClient.Deserialize(localVarResponse, typeof(BccEmailArchiveList)));
