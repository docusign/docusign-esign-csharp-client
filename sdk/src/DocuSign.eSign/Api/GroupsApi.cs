    ...
    public partial class GroupsApi : IGroupsApi
    {
        ...
        public ApiResponse< GroupInformation > ListGroupsWithHttpInfo (string accountId, GroupsApi.ListGroupsOptions options = null)
        {
            ...
            if (options != null)
            {
                ...
                if (options.includeUsercount != null) localVarQueryParams.Add("include_usercount", Configuration.ApiClient.ParameterToString(options.includeUsercount)); // query parameter
