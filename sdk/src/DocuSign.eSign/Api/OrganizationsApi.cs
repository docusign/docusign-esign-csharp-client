...
namespace DocuSign.eSign.Api
{
    ...
    public partial class OrganizationsApi : IOrganizationsApi
    {
        ...
        public ApiResponse<Object> DeleteReportWithHttpInfo (string organizationId, string reportCorrelationId)
        {
            ...
            if (reportCorrelationId != null) localVarPathParams.Add("reportCorrelationId", Configuration.ApiClient.ParameterToString(reportCorrelationId)); // path parameter
        ...
        public ApiResponse<Object> GetAccountSettingsExportWithHttpInfo (string organizationId, string resultId)
        {
            ...
            var localVarPath = "/v2.1/organization_exports/{organizationId}/account_settings/{resultId}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
