...
namespace DocuSign.eSign.Api
{
    ...
    /// </summary>
    public interface ITSPsApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class TSPsApi : ITSPsApi
    {
        private DocuSign.eSign.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="TSPsApi"/> class.
        /// </summary>
        /// <returns></returns>
        public TSPsApi(String basePath)
        {
        ...
        /// <returns></returns>
        public TSPsApi(Configuration configuration = null)
        {
