...
namespace DocuSign.eSign.Api
{
    ...
    public partial class UsersApi : IUsersApi
    {
        ...
        public ApiResponse< ContactGetResponse > GetContactByIdWithHttpInfo (string accountId, string contactId, UsersApi.GetContactByIdOptions options = null)
        {
            ...
            if (options != null)
            {
                if (options.cloudProvider != null) localVarQueryParams.Add("cloud_provider", Configuration.ApiClient.ParameterToString(options.cloudProvider)); // query parameter
            }
        ...
        public ApiResponse< UserSignature > UpdateSignatureImageWithHttpInfo (string accountId, string userId, string signatureId, string imageType, UsersApi.UpdateSignatureImageOptions options = null)
        {
            ...
            if (options != null)
            {
                if (options.transparentPng != null) localVarQueryParams.Add("transparent_png", Configuration.ApiClient.ParameterToString(options.transparentPng)); // query parameter
            }
