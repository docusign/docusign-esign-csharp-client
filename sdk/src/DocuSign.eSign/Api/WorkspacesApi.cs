...
namespace DocuSign.eSign.Api
{
    ...
    public partial class WorkspacesApi : IWorkspacesApi
    {
        ...
        /// <returns></returns>
        public WorkspacesApi(DocuSignClient aplClient)
        {
        ...
        public ApiResponse<Workspace> CreateWorkspaceWithHttpInfo(string accountId, Workspace workspace = null)
        {
            ...
            {
                return new ApiResponse<Workspace>(localVarStatusCode, localVarResponse.Headers.ToDictionary(x => x.Key, x => x.Value.ToString()), (Workspace)this.ApiClient.Deserialize(localVarResponse.RawBytes, typeof(Workspace)));
            }
            else
            {
                return new ApiResponse<Workspace>(localVarStatusCode, localVarResponse.Headers.ToDictionary(x => x.Key, x => x.Value.ToString()), (Workspace)this.ApiClient.Deserialize(localVarResponse, typeof(Workspace)));
            }
        ...
        public ApiResponse<WorkspaceItem> CreateWorkspaceFileWithHttpInfo(string accountId, string workspaceId, string folderId)
        {
            ...
            if (localVarResponse.ContentType != null && !localVarResponse.ContentType.ToLower().Contains("json"))
            {
                return new ApiResponse<WorkspaceItem>(localVarStatusCode, localVarResponse.Headers.ToDictionary(x => x.Key, x => x.Value.ToString()), (WorkspaceItem)this.ApiClient.Deserialize(localVarResponse.RawBytes, typeof(WorkspaceItem)));
            }
            else
            {
                return new ApiResponse<WorkspaceItem>(localVarStatusCode, localVarResponse.Headers.ToDictionary(x => x.Key, x => x.Value.ToString()), (WorkspaceItem)this.ApiClient.Deserialize(localVarResponse, typeof(WorkspaceItem)));
            }
        ...
        public ApiResponse<WorkspaceFolderContents> ListWorkspaceFolderItemsWithHttpInfo(string accountId, string workspaceId, string folderId, WorkspacesApi.ListWorkspaceFolderItemsOptions options = null)
        {
            ...
            if (localVarResponse.ContentType != null && !localVarResponse.ContentType.ToLower().Contains("json"))
            {
                return new ApiResponse<WorkspaceFolderContents>(localVarStatusCode, localVarResponse.Headers.ToDictionary(x => x.Key, x => x.Value.ToString()), (WorkspaceFolderContents)this.ApiClient.Deserialize(localVarResponse.RawBytes, typeof(WorkspaceFolderContents)));
            }
            else
            {
                return new ApiResponse<WorkspaceFolderContents>(localVarStatusCode, localVarResponse.Headers.ToDictionary(x => x.Key, x => x.Value.ToString()), (WorkspaceFolderContents)this.ApiClient.Deserialize(localVarResponse, typeof(WorkspaceFolderContents)));
            }
        ...
        public ApiResponse<WorkspaceList> ListWorkspacesWithHttpInfo(string accountId)
        {
            ...
            if (localVarResponse.ContentType != null && !localVarResponse.ContentType.ToLower().Contains("json"))
            {
                return new ApiResponse<WorkspaceList>(localVarStatusCode, localVarResponse.Headers.ToDictionary(x => x.Key, x => x.Value.ToString()), (WorkspaceList)this.ApiClient.Deserialize(localVarResponse.RawBytes, typeof(WorkspaceList)));
            }
            else
            {
                return new ApiResponse<WorkspaceList>(localVarStatusCode, localVarResponse.Headers.ToDictionary(x => x.Key, x => x.Value.ToString()), (WorkspaceList)this.ApiClient.Deserialize(localVarResponse, typeof(WorkspaceList)));
            }
