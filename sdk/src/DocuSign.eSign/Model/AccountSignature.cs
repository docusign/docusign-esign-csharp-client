...
namespace DocuSign.eSign.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AccountSignature :  IEquatable<AccountSignature>, IValidatableObject
    {
        ...
        public List<SignatureGroup> SignatureGroups { get; set; }
        /// <summary>
        ...
        public List<SignatureUser> SignatureUsers { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AccountSignature);
        }

        /// <summary>
        /// Returns true if AccountSignature instances are equal
        /// </summary>
        /// <param name="other">Instance of AccountSignature to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountSignature other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
