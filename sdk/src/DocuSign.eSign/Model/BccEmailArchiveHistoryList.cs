...
namespace DocuSign.eSign.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BccEmailArchiveHistoryList :  IEquatable<BccEmailArchiveHistoryList>, IValidatableObject
    {
        public BccEmailArchiveHistoryList()
        {
            // Empty Constructor
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  BccEmailArchiveHistory: ").Append(BccEmailArchiveHistory).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BccEmailArchiveHistoryList);
        }

        /// <summary>
        /// Returns true if BccEmailArchiveHistoryList instances are equal
        /// </summary>
        /// <param name="other">Instance of BccEmailArchiveHistoryList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BccEmailArchiveHistoryList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    this.BccEmailArchiveHistory == other.BccEmailArchiveHistory ||
                    this.BccEmailArchiveHistory != null &&
                    this.BccEmailArchiveHistory.SequenceEqual(other.BccEmailArchiveHistory)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.BccEmailArchiveHistory != null)
                    hash = hash * 59 + this.BccEmailArchiveHistory.GetHashCode();
