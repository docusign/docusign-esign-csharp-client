...
namespace DocuSign.eSign.Model
{
    ...
    {
        public BccEmailArchiveList()
        {
            // Empty Constructor
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="BccEmailArchiveList" /> class.
        /// </summary>
        /// <param name="BccEmailArchives">BccEmailArchives.</param>
        ...
        public BccEmailArchiveList(List<BccEmailArchive> BccEmailArchives = default(List<BccEmailArchive>), string EndPosition = default(string), string NextUri = default(string), string PreviousUri = default(string), string ResultSetSize = default(string), string StartPosition = default(string), string TotalSetSize = default(string))
        {
        ...
        /// <summary>
        /// Gets or Sets BccEmailArchives
        /// </summary>
        [DataMember(Name="bccEmailArchives", EmitDefaultValue=false)]
        public List<BccEmailArchive> BccEmailArchives { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  BccEmailArchives: ").Append(BccEmailArchives).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BccEmailArchiveList);
        }

        /// <summary>
        /// Returns true if BccEmailArchiveList instances are equal
        /// </summary>
        /// <param name="other">Instance of BccEmailArchiveList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BccEmailArchiveList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    this.BccEmailArchives == other.BccEmailArchives ||
                    this.BccEmailArchives != null &&
                    this.BccEmailArchives.SequenceEqual(other.BccEmailArchives)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.BccEmailArchives != null)
                    hash = hash * 59 + this.BccEmailArchives.GetHashCode();
