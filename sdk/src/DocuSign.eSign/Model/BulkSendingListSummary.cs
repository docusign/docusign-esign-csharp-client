...
namespace DocuSign.eSign.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BulkSendingListSummary :  IEquatable<BulkSendingListSummary>, IValidatableObject
    {
        public BulkSendingListSummary()
        {
            // Empty Constructor
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  BulkSendListId: ").Append(BulkSendListId).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BulkSendingListSummary);
        }

        /// <summary>
        /// Returns true if BulkSendingListSummary instances are equal
        /// </summary>
        /// <param name="other">Instance of BulkSendingListSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BulkSendingListSummary other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    this.BulkSendListId == other.BulkSendListId ||
                    this.BulkSendListId != null &&
                    this.BulkSendListId.Equals(other.BulkSendListId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.BulkSendListId != null)
                    hash = hash * 59 + this.BulkSendListId.GetHashCode();
