...
namespace DocuSign.eSign.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CommentThread :  IEquatable<CommentThread>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CommentThread);
        }

        /// <summary>
        /// Returns true if CommentThread instances are equal
        /// </summary>
        /// <param name="other">Instance of CommentThread to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CommentThread other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
