...
namespace DocuSign.eSign.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CommissionExpiration :  IEquatable<CommissionExpiration>, IValidatableObject
    {
        public CommissionExpiration()
        {
            // Empty Constructor
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="CommissionExpiration" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CommissionExpiration);
        }

        /// <summary>
        /// Returns true if CommissionExpiration instances are equal
        /// </summary>
        /// <param name="other">Instance of CommissionExpiration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CommissionExpiration other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
