...
namespace DocuSign.eSign.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DocGenFormFieldRowValue :  IEquatable<DocGenFormFieldRowValue>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DocGenFormFieldRowValue" /> class.
        /// </summary>
        /// <param name="DocGenFormFieldList">DocGenFormFieldList.</param>
        public DocGenFormFieldRowValue(List<DocGenFormField> DocGenFormFieldList = default(List<DocGenFormField>))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DocGenFormFieldRowValue);
        }

        /// <summary>
        /// Returns true if DocGenFormFieldRowValue instances are equal
        /// </summary>
        /// <param name="other">Instance of DocGenFormFieldRowValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocGenFormFieldRowValue other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
