...
namespace DocuSign.eSign.Model
{
    ...
    public partial class Draw :  IEquatable<Draw>, IValidatableObject
    {
        ...
        /// <param name="AllowSignerUpload">AllowSignerUpload.</param>
        ...
        /// <param name="UseBackgroundAsCanvas">UseBackgroundAsCanvas.</param>
        ...
        /// </summary>
        [DataMember(Name="allowSignerUpload", EmitDefaultValue=false)]
        public string AllowSignerUpload { get; set; }
        /// <summary>
        ...
        /// </summary>
        [DataMember(Name="useBackgroundAsCanvas", EmitDefaultValue=false)]
        public string UseBackgroundAsCanvas { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AllowSignerUpload: ").Append(AllowSignerUpload).Append("\n");
            ...
            sb.Append("  UseBackgroundAsCanvas: ").Append(UseBackgroundAsCanvas).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Draw);
        }

        /// <summary>
        /// Returns true if Draw instances are equal
        /// </summary>
        /// <param name="other">Instance of Draw to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Draw other)
        {
            ...
            return 
                ...
                (
                    this.AllowSignerUpload == other.AllowSignerUpload ||
                    this.AllowSignerUpload != null &&
                    this.AllowSignerUpload.Equals(other.AllowSignerUpload)
                ) && 
                (
                ...
                (
                    this.UseBackgroundAsCanvas == other.UseBackgroundAsCanvas ||
                    this.UseBackgroundAsCanvas != null &&
                    this.UseBackgroundAsCanvas.Equals(other.UseBackgroundAsCanvas)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AllowSignerUpload != null)
                    hash = hash * 59 + this.AllowSignerUpload.GetHashCode();
                ...
                if (this.UseBackgroundAsCanvas != null)
                    hash = hash * 59 + this.UseBackgroundAsCanvas.GetHashCode();
