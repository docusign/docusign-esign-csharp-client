...
namespace DocuSign.eSign.Model
{
    ...
    public partial class EnvelopeFormData :  IEquatable<EnvelopeFormData>, IValidatableObject
    {
        ...
        public EnvelopeFormData(string EmailSubject = default(string), string EnvelopeId = default(string), List<FormDataItem> FormData = default(List<FormDataItem>), List<RecipientFormData> RecipientFormData = default(List<RecipientFormData>), string SentDateTime = default(string), string Status = default(string))
        {
