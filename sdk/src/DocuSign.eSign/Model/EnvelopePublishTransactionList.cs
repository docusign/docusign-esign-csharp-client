...
namespace DocuSign.eSign.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EnvelopePublishTransactionList :  IEquatable<EnvelopePublishTransactionList>, IValidatableObject
    {
        public EnvelopePublishTransactionList()
        {
            // Empty Constructor
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="EnvelopePublishTransactionList" /> class.
        /// </summary>
        /// <param name="EndPosition">The last position in the result set. .</param>
        /// <param name="EnvelopePublishTransactions">.</param>
        ...
        /// </summary>
        /// <value></value>
        [DataMember(Name="envelopePublishTransactions", EmitDefaultValue=false)]
        public List<EnvelopePublishTransaction> EnvelopePublishTransactions { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  EnvelopePublishTransactions: ").Append(EnvelopePublishTransactions).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EnvelopePublishTransactionList);
        }

        /// <summary>
        /// Returns true if EnvelopePublishTransactionList instances are equal
        /// </summary>
        /// <param name="other">Instance of EnvelopePublishTransactionList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnvelopePublishTransactionList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.EnvelopePublishTransactions == other.EnvelopePublishTransactions ||
                    this.EnvelopePublishTransactions != null &&
                    this.EnvelopePublishTransactions.SequenceEqual(other.EnvelopePublishTransactions)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EnvelopePublishTransactions != null)
                    hash = hash * 59 + this.EnvelopePublishTransactions.GetHashCode();
