...
namespace DocuSign.eSign.Model
{
    ...
    {
        public EnvelopeTransferRuleRequest()
        {
            // Empty Constructor
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  FromGroups: ").Append(FromGroups).Append("\n");
            sb.Append("  FromUsers: ").Append(FromUsers).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EnvelopeTransferRuleRequest);
        }

        /// <summary>
        /// Returns true if EnvelopeTransferRuleRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of EnvelopeTransferRuleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnvelopeTransferRuleRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.FromGroups == other.FromGroups ||
                    this.FromGroups != null &&
                    this.FromGroups.SequenceEqual(other.FromGroups)
                ) && 
                (
                    this.FromUsers == other.FromUsers ||
                    this.FromUsers != null &&
                    this.FromUsers.SequenceEqual(other.FromUsers)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.FromGroups != null)
                    hash = hash * 59 + this.FromGroups.GetHashCode();
                if (this.FromUsers != null)
                    hash = hash * 59 + this.FromUsers.GetHashCode();
