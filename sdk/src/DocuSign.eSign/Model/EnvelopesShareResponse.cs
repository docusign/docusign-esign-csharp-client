...
namespace DocuSign.eSign.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EnvelopesShareResponse :  IEquatable<EnvelopesShareResponse>, IValidatableObject
    {
        public EnvelopesShareResponse()
        {
            // Empty Constructor
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="EnvelopesShareResponse" /> class.
        /// </summary>
        ...
        public EnvelopesShareResponse(AuthorizationUser AgentUser = default(AuthorizationUser), string CreatedTimestamp = default(string), string EnvelopeId = default(string), ErrorDetails ErrorDetails = default(ErrorDetails), string ModifiedTimestamp = default(string), string Permission = default(string), AuthorizationUser SenderInfo = default(AuthorizationUser), string ShareId = default(string), string Subject = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EnvelopesShareResponse {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EnvelopesShareResponse);
        }

        /// <summary>
        /// Returns true if EnvelopesShareResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of EnvelopesShareResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnvelopesShareResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
