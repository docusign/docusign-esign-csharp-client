...
namespace DocuSign.eSign.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExternalClaim :  IEquatable<ExternalClaim>, IValidatableObject
    {
        public ExternalClaim()
        {
            // Empty Constructor
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ExternalClaim);
        }

        /// <summary>
        /// Returns true if ExternalClaim instances are equal
        /// </summary>
        /// <param name="other">Instance of ExternalClaim to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExternalClaim other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    ...
                    this.AcquiredTime.Equals(other.AcquiredTime)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AcquiredTime != null)
                    hash = hash * 59 + this.AcquiredTime.GetHashCode();
