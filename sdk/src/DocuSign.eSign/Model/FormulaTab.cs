...
namespace DocuSign.eSign.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FormulaTab :  IEquatable<FormulaTab>, IValidatableObject
    {
        public FormulaTab()
        {
            // Empty Constructor
        ...
        /// </summary>
        /// <param name="AgreementAttribute">AgreementAttribute.</param>
        /// <param name="AgreementAttributeLocked">AgreementAttributeLocked.</param>
        ...
        /// <param name="FormulaMetadata">Metadata indicating if the sender can edit the &#x60;formula&#x60; property..</param>
        ...
        /// <param name="HiddenMetadata">Metadata that indicates whether the &#x60;hidden&#x60; property is editable..</param>
        ...
        /// <param name="IsPaymentAmountMetadata">Reserved for DocuSign..</param>
        ...
        /// <param name="RoundDecimalPlacesMetadata">Metadata that indicates whether the &#x60;roundDecimalPlaces&#x60; property is editable..</param>
        ...
        /// <summary>
        /// Gets or Sets AgreementAttribute
        /// </summary>
        [DataMember(Name="agreementAttribute", EmitDefaultValue=false)]
        public string AgreementAttribute { get; set; }
        /// <summary>
        /// Gets or Sets AgreementAttributeLocked
        /// </summary>
        [DataMember(Name="agreementAttributeLocked", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value>Metadata indicating if the sender can edit the &#x60;formula&#x60; property.</value>
        [DataMember(Name="formulaMetadata", EmitDefaultValue=false)]
        public PropertyMetadata FormulaMetadata { get; set; }
        /// <summary>
        ...
        /// </summary>
        /// <value>Metadata that indicates whether the &#x60;hidden&#x60; property is editable.</value>
        [DataMember(Name="hiddenMetadata", EmitDefaultValue=false)]
        public PropertyMetadata HiddenMetadata { get; set; }
        /// <summary>
        ...
        /// </summary>
        /// <value>Reserved for DocuSign.</value>
        [DataMember(Name="isPaymentAmountMetadata", EmitDefaultValue=false)]
        public PropertyMetadata IsPaymentAmountMetadata { get; set; }
        /// <summary>
        ...
        /// </summary>
        /// <value>Metadata that indicates whether the &#x60;roundDecimalPlaces&#x60; property is editable.</value>
        [DataMember(Name="roundDecimalPlacesMetadata", EmitDefaultValue=false)]
        public PropertyMetadata RoundDecimalPlacesMetadata { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AgreementAttribute: ").Append(AgreementAttribute).Append("\n");
            sb.Append("  AgreementAttributeLocked: ").Append(AgreementAttributeLocked).Append("\n");
            ...
            sb.Append("  FormulaMetadata: ").Append(FormulaMetadata).Append("\n");
            sb.Append("  Height: ").Append(Height).Append("\n");
            sb.Append("  HeightMetadata: ").Append(HeightMetadata).Append("\n");
            sb.Append("  Hidden: ").Append(Hidden).Append("\n");
            sb.Append("  HiddenMetadata: ").Append(HiddenMetadata).Append("\n");
            sb.Append("  IsPaymentAmount: ").Append(IsPaymentAmount).Append("\n");
            sb.Append("  IsPaymentAmountMetadata: ").Append(IsPaymentAmountMetadata).Append("\n");
            ...
            sb.Append("  RoundDecimalPlacesMetadata: ").Append(RoundDecimalPlacesMetadata).Append("\n");
        ...
        public bool Equals(FormulaTab other)
        {
            ...
            return 
                (
                    this.AgreementAttribute == other.AgreementAttribute ||
                    this.AgreementAttribute != null &&
                    this.AgreementAttribute.Equals(other.AgreementAttribute)
                ) && 
                (
                    this.AgreementAttributeLocked == other.AgreementAttributeLocked ||
                    this.AgreementAttributeLocked != null &&
                    this.AgreementAttributeLocked.Equals(other.AgreementAttributeLocked)
                ) && 
                (
                ...
                (
                    this.FormulaMetadata == other.FormulaMetadata ||
                    this.FormulaMetadata != null &&
                    this.FormulaMetadata.Equals(other.FormulaMetadata)
                ) && 
                (
                ...
                (
                    this.HiddenMetadata == other.HiddenMetadata ||
                    this.HiddenMetadata != null &&
                    this.HiddenMetadata.Equals(other.HiddenMetadata)
                ) && 
                (
                ...
                (
                    this.IsPaymentAmountMetadata == other.IsPaymentAmountMetadata ||
                    this.IsPaymentAmountMetadata != null &&
                    this.IsPaymentAmountMetadata.Equals(other.IsPaymentAmountMetadata)
                ) && 
                (
                ...
                (
                    this.RoundDecimalPlacesMetadata == other.RoundDecimalPlacesMetadata ||
                    this.RoundDecimalPlacesMetadata != null &&
                    this.RoundDecimalPlacesMetadata.Equals(other.RoundDecimalPlacesMetadata)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AgreementAttribute != null)
                    hash = hash * 59 + this.AgreementAttribute.GetHashCode();
                if (this.AgreementAttributeLocked != null)
                    hash = hash * 59 + this.AgreementAttributeLocked.GetHashCode();
                ...
                if (this.FormulaMetadata != null)
                    hash = hash * 59 + this.FormulaMetadata.GetHashCode();
                if (this.Height != null)
                ...
                if (this.HiddenMetadata != null)
                    hash = hash * 59 + this.HiddenMetadata.GetHashCode();
                if (this.IsPaymentAmount != null)
                    hash = hash * 59 + this.IsPaymentAmount.GetHashCode();
                if (this.IsPaymentAmountMetadata != null)
                    hash = hash * 59 + this.IsPaymentAmountMetadata.GetHashCode();
                if (this.Italic != null)
                ...
                if (this.RoundDecimalPlacesMetadata != null)
                    hash = hash * 59 + this.RoundDecimalPlacesMetadata.GetHashCode();
