...
namespace DocuSign.eSign.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GroupInformation :  IEquatable<GroupInformation>, IValidatableObject
    {
        ...
        public GroupInformation(string EndPosition = default(string), List<Group> Groups = default(List<Group>), string NextUri = default(string), string PreviousUri = default(string), string ResultSetSize = default(string), string StartPosition = default(string), string TotalSetSize = default(string))
        {
