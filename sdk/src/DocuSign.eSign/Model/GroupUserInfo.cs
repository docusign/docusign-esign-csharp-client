...
namespace DocuSign.eSign.Model
{
    ...
    public partial class GroupUserInfo :  IEquatable<GroupUserInfo>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GroupUserInfo);
        }

        /// <summary>
        /// Returns true if GroupUserInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of GroupUserInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupUserInfo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
