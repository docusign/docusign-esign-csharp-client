...
namespace DocuSign.eSign.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GroupUsersResponse :  IEquatable<GroupUsersResponse>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupUsersResponse" /> class.
        /// </summary>
        ...
        public GroupUsersResponse(string EndPosition = default(string), string NextUri = default(string), string PreviousUri = default(string), string ResultSetSize = default(string), string StartPosition = default(string), string TotalSetSize = default(string), List<GroupUserInfo> Users = default(List<GroupUserInfo>))
        {
        ...
        public List<GroupUserInfo> Users { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GroupUsersResponse);
        }

        /// <summary>
        /// Returns true if GroupUsersResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of GroupUsersResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupUsersResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
