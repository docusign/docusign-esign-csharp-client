...
namespace DocuSign.eSign.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ListCustomField :  IEquatable<ListCustomField>, IValidatableObject
    {
        ...
        public ListCustomField(string ConfigurationType = default(string), ErrorDetails ErrorDetails = default(ErrorDetails), string FieldId = default(string), List<string> ListItems = default(List<string>), string Name = default(string), string Required = default(string), string Show = default(string), string Value = default(string))
        {
