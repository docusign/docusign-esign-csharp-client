...
namespace DocuSign.eSign.Model
{
    ...
    public partial class MatchBox :  IEquatable<MatchBox>, IValidatableObject
    {
        ...
        public MatchBox(string Height = default(string), string PageNumber = default(string), string Width = default(string), string XPosition = default(string), string YPosition = default(string))
        {
            this.Height = Height;
