...
namespace DocuSign.eSign.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NotaryJournalList :  IEquatable<NotaryJournalList>, IValidatableObject
    {
        ...
        /// <param name="NotaryJournals">NotaryJournals.</param>
        ...
        public NotaryJournalList(string EndPosition = default(string), string NextUri = default(string), List<NotaryJournal> NotaryJournals = default(List<NotaryJournal>), string PreviousUri = default(string), string ResultSetSize = default(string), string StartPosition = default(string), string TotalSetSize = default(string))
        {
        ...
        /// <summary>
        /// Gets or Sets NotaryJournals
        /// </summary>
        [DataMember(Name="notaryJournals", EmitDefaultValue=false)]
        public List<NotaryJournal> NotaryJournals { get; set; }
        /// <summary>
