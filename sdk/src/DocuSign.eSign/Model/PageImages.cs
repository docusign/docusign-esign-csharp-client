...
namespace DocuSign.eSign.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageImages :  IEquatable<PageImages>, IValidatableObject
    {
        public PageImages()
        {
            // Empty Constructor
        ...
        public PageImages(string EndPosition = default(string), string NextUri = default(string), List<Page> Pages = default(List<Page>), string PreviousUri = default(string), string ResultSetSize = default(string), string StartPosition = default(string), string TotalSetSize = default(string))
        {
