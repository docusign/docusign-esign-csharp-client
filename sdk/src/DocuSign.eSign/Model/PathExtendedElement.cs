...
namespace DocuSign.eSign.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PathExtendedElement :  IEquatable<PathExtendedElement>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PathExtendedElement);
        }

        /// <summary>
        /// Returns true if PathExtendedElement instances are equal
        /// </summary>
        /// <param name="other">Instance of PathExtendedElement to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PathExtendedElement other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
