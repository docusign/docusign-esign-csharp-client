...
namespace DocuSign.eSign.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PolyLineOverlay :  IEquatable<PolyLineOverlay>, IValidatableObject
    {
        ...
        /// <param name="GraphicsContext">Contains details about the style used for the strike through graphic..</param>
        ...
        /// <param name="OverlayTypeMetadata">Metadata that indicates whether the &#x60;overlayType&#x60; property is editable. .</param>
        ...
        /// </summary>
        /// <value>Contains details about the style used for the strike through graphic.</value>
        [DataMember(Name="graphicsContext", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value>Metadata that indicates whether the &#x60;overlayType&#x60; property is editable. </value>
        [DataMember(Name="overlayTypeMetadata", EmitDefaultValue=false)]
        public PropertyMetadata OverlayTypeMetadata { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  GraphicsContext: ").Append(GraphicsContext).Append("\n");
            ...
            sb.Append("  OverlayType: ").Append(OverlayType).Append("\n");
            sb.Append("  OverlayTypeMetadata: ").Append(OverlayTypeMetadata).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PolyLineOverlay);
        }

        /// <summary>
        /// Returns true if PolyLineOverlay instances are equal
        /// </summary>
        /// <param name="other">Instance of PolyLineOverlay to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PolyLineOverlay other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.GraphicsContext == other.GraphicsContext ||
                    this.GraphicsContext != null &&
                    this.GraphicsContext.Equals(other.GraphicsContext)
                ) && 
                (
                ...
                (
                    ...
                    this.OverlayType.Equals(other.OverlayType)
                ) && 
                (
                    this.OverlayTypeMetadata == other.OverlayTypeMetadata ||
                    this.OverlayTypeMetadata != null &&
                    this.OverlayTypeMetadata.Equals(other.OverlayTypeMetadata)
                ) && 
                (
                ...
                (
                    ...
                    this.PolyLines != null &&
                    this.PolyLines.SequenceEqual(other.PolyLines)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.GraphicsContext != null)
                    hash = hash * 59 + this.GraphicsContext.GetHashCode();
                if (this.Height != null)
                ...
                if (this.OverlayType != null)
                    hash = hash * 59 + this.OverlayType.GetHashCode();
                if (this.OverlayTypeMetadata != null)
                    hash = hash * 59 + this.OverlayTypeMetadata.GetHashCode();
                if (this.PageNumber != null)
                    hash = hash * 59 + this.PageNumber.GetHashCode();
                if (this.PageNumberMetadata != null)
                    hash = hash * 59 + this.PageNumberMetadata.GetHashCode();
                if (this.PolyLines != null)
                    hash = hash * 59 + this.PolyLines.GetHashCode();
