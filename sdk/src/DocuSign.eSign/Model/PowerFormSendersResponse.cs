...
namespace DocuSign.eSign.Model
{
    ...
    {
        public PowerFormSendersResponse()
        {
            // Empty Constructor
        }
        ...
        /// <param name="PowerFormSenders">PowerFormSenders.</param>
        ...
        public PowerFormSendersResponse(string EndPosition = default(string), string NextUri = default(string), List<UserInfo> PowerFormSenders = default(List<UserInfo>), string PreviousUri = default(string), string ResultSetSize = default(string), string StartPosition = default(string), string TotalSetSize = default(string))
        {
