...
namespace DocuSign.eSign.Model
{
    ...
    public partial class PowerFormSendersResponse :  IEquatable<PowerFormSendersResponse>, IValidatableObject
    {
        ...
        public PowerFormSendersResponse(int? EndPosition = default(int?), string NextUri = default(string), List<UserInfo> PowerFormSenders = default(List<UserInfo>), string PreviousUri = default(string), int? ResultSetSize = default(int?), int? StartPosition = default(int?), int? TotalSetSize = default(int?))
        {
