...
namespace DocuSign.eSign.Model
{
    ...
    public partial class PrefillFormData :  IEquatable<PrefillFormData>, IValidatableObject
    {
        ...
        public PrefillFormData(List<NameValue> FormData = default(List<NameValue>), string SenderEmail = default(string), string SenderName = default(string), string SenderUserId = default(string))
        {
