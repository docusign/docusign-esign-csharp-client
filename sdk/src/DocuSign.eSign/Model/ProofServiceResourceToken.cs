...
namespace DocuSign.eSign.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProofServiceResourceToken :  IEquatable<ProofServiceResourceToken>, IValidatableObject
    {
        public ProofServiceResourceToken()
        {
            // Empty Constructor
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProofServiceResourceToken);
        }

        /// <summary>
        /// Returns true if ProofServiceResourceToken instances are equal
        /// </summary>
        /// <param name="other">Instance of ProofServiceResourceToken to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProofServiceResourceToken other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
