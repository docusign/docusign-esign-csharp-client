...
namespace DocuSign.eSign.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ReportInProductRunRequest :  IEquatable<ReportInProductRunRequest>, IValidatableObject
    {
        public ReportInProductRunRequest()
        {
            // Empty Constructor
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ReportInProductRunRequest);
        }

        /// <summary>
        /// Returns true if ReportInProductRunRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of ReportInProductRunRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReportInProductRunRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
