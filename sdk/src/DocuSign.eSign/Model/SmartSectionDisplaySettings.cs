...
namespace DocuSign.eSign.Model
{
    ...
    public partial class SmartSectionDisplaySettings :  IEquatable<SmartSectionDisplaySettings>, IValidatableObject
    {
        ...
        public SmartSectionDisplaySettings(string CellStyle = default(string), SmartSectionCollapsibleDisplaySettings CollapsibleSettings = default(SmartSectionCollapsibleDisplaySettings), string Display = default(string), string DisplayLabel = default(string), int? DisplayOrder = default(int?), int? DisplayPageNumber = default(int?), bool? HideLabelWhenOpened = default(bool?), string InlineOuterStyle = default(string), string LabelWhenOpened = default(string), bool? ScrollToTopWhenOpened = default(bool?), string TableStyle = default(string))
        {
