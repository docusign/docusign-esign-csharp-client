...
namespace DocuSign.eSign.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TemplateViewSettings :  IEquatable<TemplateViewSettings>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateViewSettings" /> class.
        /// </summary>
        ...
        public TemplateViewSettings(string BackButtonAction = default(string), EnvelopeViewDocumentSettings DocumentSettings = default(EnvelopeViewDocumentSettings), EnvelopeViewEnvelopeCustomFieldSettings EnvelopeCustomFieldSettings = default(EnvelopeViewEnvelopeCustomFieldSettings), string LockToken = default(string), TemplateViewRecipientSettings RecipientSettings = default(TemplateViewRecipientSettings), string ShowAdvancedOptions = default(string), string ShowBackButton = default(string), string ShowDiscardAction = default(string), string ShowHeaderActions = default(string), string StartingScreen = default(string), EnvelopeViewTaggerSettings TaggerSettings = default(EnvelopeViewTaggerSettings))
        {
        ...
        public TemplateViewRecipientSettings RecipientSettings { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TemplateViewSettings);
        }

        /// <summary>
        /// Returns true if TemplateViewSettings instances are equal
        /// </summary>
        /// <param name="other">Instance of TemplateViewSettings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TemplateViewSettings other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
