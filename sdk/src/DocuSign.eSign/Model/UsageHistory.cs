...
namespace DocuSign.eSign.Model
{
    ...
    public partial class UsageHistory :  IEquatable<UsageHistory>, IValidatableObject
    {
        ...
        public UsageHistory(string LastSentDateTime = default(string), string LastSignedDateTime = default(string), string SentCount = default(string), string SignedCount = default(string))
        {
