...
namespace DocuSign.eSign.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserAuthorizationCreateRequestWithId :  IEquatable<UserAuthorizationCreateRequestWithId>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UserAuthorizationCreateRequestWithId" /> class.
        /// </summary>
        ...
        public UserAuthorizationCreateRequestWithId(AuthorizationUser AgentUser = default(AuthorizationUser), string AuthorizationId = default(string), string EndDate = default(string), string Permission = default(string), string StartDate = default(string), string TaskSource = default(string), string TaskType = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UserAuthorizationCreateRequestWithId);
        }

        /// <summary>
        /// Returns true if UserAuthorizationCreateRequestWithId instances are equal
        /// </summary>
        /// <param name="other">Instance of UserAuthorizationCreateRequestWithId to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserAuthorizationCreateRequestWithId other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
