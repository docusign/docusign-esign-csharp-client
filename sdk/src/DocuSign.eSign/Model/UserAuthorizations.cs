...
namespace DocuSign.eSign.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserAuthorizations :  IEquatable<UserAuthorizations>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UserAuthorizations" /> class.
        /// </summary>
        ...
        public UserAuthorizations(List<UserAuthorization> Authorizations = default(List<UserAuthorization>), string EndPosition = default(string), string NextUri = default(string), string PreviousUri = default(string), string ResultSetSize = default(string), string StartPosition = default(string), string TotalSetSize = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UserAuthorizations);
        }

        /// <summary>
        /// Returns true if UserAuthorizations instances are equal
        /// </summary>
        /// <param name="other">Instance of UserAuthorizations to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserAuthorizations other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
