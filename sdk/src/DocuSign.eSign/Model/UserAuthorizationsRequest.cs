...
namespace DocuSign.eSign.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserAuthorizationsRequest :  IEquatable<UserAuthorizationsRequest>, IValidatableObject
    {
        public UserAuthorizationsRequest()
        {
            // Empty Constructor
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UserAuthorizationsRequest);
        }

        /// <summary>
        /// Returns true if UserAuthorizationsRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of UserAuthorizationsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserAuthorizationsRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
