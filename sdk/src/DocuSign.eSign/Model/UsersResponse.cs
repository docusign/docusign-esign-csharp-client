...
namespace DocuSign.eSign.Model
{
    ...
    public partial class UsersResponse :  IEquatable<UsersResponse>, IValidatableObject
    {
        ...
        public UsersResponse(string EndPosition = default(string), string NextUri = default(string), string PreviousUri = default(string), string ResultSetSize = default(string), string StartPosition = default(string), string TotalSetSize = default(string), List<UserInfo> Users = default(List<UserInfo>))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UsersResponse);
        }

        /// <summary>
        /// Returns true if UsersResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of UsersResponse to be compared</param>
        /// <returns>Boolean</returns>
