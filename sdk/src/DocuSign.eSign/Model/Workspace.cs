...
namespace DocuSign.eSign.Model
{
    ...
    public partial class Workspace :  IEquatable<Workspace>, IValidatableObject
    {
        ...
        /// </summary>
        [DataMember(Name="callerInformation", EmitDefaultValue=false)]
        public WorkspaceUser CallerInformation { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CallerInformation: ").Append(CallerInformation).Append("\n");
        ...
        public bool Equals(Workspace other)
        {
            ...
            return 
                ...
                (
                    this.CallerInformation == other.CallerInformation ||
                    this.CallerInformation != null &&
                    this.CallerInformation.Equals(other.CallerInformation)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CallerInformation != null)
                    hash = hash * 59 + this.CallerInformation.GetHashCode();
