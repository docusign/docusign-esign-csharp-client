...
namespace DocuSign.eSign.Model
{
    ...
    public partial class WorkspaceItem :  IEquatable<WorkspaceItem>, IValidatableObject
    {
        ...
        /// </summary>
        [DataMember(Name="userAuthorization", EmitDefaultValue=false)]
        public WorkspaceUserAuthorization UserAuthorization { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ThumbHeight: ").Append(ThumbHeight).Append("\n");
            sb.Append("  Thumbnail: ").Append(Thumbnail).Append("\n");
            sb.Append("  ThumbWidth: ").Append(ThumbWidth).Append("\n");
            sb.Append("  Type: ").Append(Type).Append("\n");
            sb.Append("  Uri: ").Append(Uri).Append("\n");
            sb.Append("  UserAuthorization: ").Append(UserAuthorization).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(WorkspaceItem other)
        {
            ...
            return 
                ...
                (
                    ...
                    this.ThumbHeight.Equals(other.ThumbHeight)
                ) && 
                (
                ...
                (
                    ...
                    this.ThumbWidth.Equals(other.ThumbWidth)
                ) && 
                (
                ...
                (
                    this.UserAuthorization == other.UserAuthorization ||
                    this.UserAuthorization != null &&
                    this.UserAuthorization.Equals(other.UserAuthorization)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ThumbHeight != null)
                    hash = hash * 59 + this.ThumbHeight.GetHashCode();
                if (this.Thumbnail != null)
                    hash = hash * 59 + this.Thumbnail.GetHashCode();
                if (this.ThumbWidth != null)
                    hash = hash * 59 + this.ThumbWidth.GetHashCode();
                if (this.Type != null)
                    hash = hash * 59 + this.Type.GetHashCode();
                if (this.Uri != null)
                    hash = hash * 59 + this.Uri.GetHashCode();
                if (this.UserAuthorization != null)
                    hash = hash * 59 + this.UserAuthorization.GetHashCode();
                return hash;
            }
        }
