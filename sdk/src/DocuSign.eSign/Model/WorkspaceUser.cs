...
namespace DocuSign.eSign.Model
{
    ...
    public partial class WorkspaceUser :  IEquatable<WorkspaceUser>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("  InvitationEmailBlurb: ").Append(InvitationEmailBlurb).Append("\n");
            sb.Append("  InvitationEmailSubject: ").Append(InvitationEmailSubject).Append("\n");
            ...
            sb.Append("  WorkspaceUserUri: ").Append(WorkspaceUserUri).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(WorkspaceUser other)
        {
            ...
            return 
                ...
                (
                    this.InvitationEmailBlurb == other.InvitationEmailBlurb ||
                    this.InvitationEmailBlurb != null &&
                    this.InvitationEmailBlurb.Equals(other.InvitationEmailBlurb)
                ) && 
                (
                    this.InvitationEmailSubject == other.InvitationEmailSubject ||
                    this.InvitationEmailSubject != null &&
                    this.InvitationEmailSubject.Equals(other.InvitationEmailSubject)
                ) && 
                (
                ...
                (
                    this.WorkspaceUserUri == other.WorkspaceUserUri ||
                    this.WorkspaceUserUri != null &&
                    this.WorkspaceUserUri.Equals(other.WorkspaceUserUri)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.InvitationEmailBlurb != null)
                    hash = hash * 59 + this.InvitationEmailBlurb.GetHashCode();
                if (this.InvitationEmailSubject != null)
                    hash = hash * 59 + this.InvitationEmailSubject.GetHashCode();
                ...
                if (this.WorkspaceUserUri != null)
                    hash = hash * 59 + this.WorkspaceUserUri.GetHashCode();
                return hash;
            }
        }
