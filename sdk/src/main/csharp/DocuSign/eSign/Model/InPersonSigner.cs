...
namespace DocuSign.eSign.Model
{
    ...
    /// </summary>
    [DataContract]
    public class InPersonSigner : IEquatable<InPersonSigner>
    {
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.HostName != null)
                    hash = hash * 57 + this.HostName.GetHashCode();
                
                if (this.HostEmail != null)
                    hash = hash * 57 + this.HostEmail.GetHashCode();
                
                if (this.SignerName != null)
                    hash = hash * 57 + this.SignerName.GetHashCode();
                
                if (this.SignerEmail != null)
                    hash = hash * 57 + this.SignerEmail.GetHashCode();
