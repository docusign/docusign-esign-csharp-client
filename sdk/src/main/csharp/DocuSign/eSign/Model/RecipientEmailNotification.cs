...
namespace DocuSign.eSign.Model
{
    ...
    /// </summary>
    [DataContract]
    public class RecipientEmailNotification : IEquatable<RecipientEmailNotification>
    {
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EmailBody != null)
                    hash = hash * 57 + this.EmailBody.GetHashCode();
                
                if (this.SupportedLanguage != null)
                    hash = hash * 57 + this.SupportedLanguage.GetHashCode();
