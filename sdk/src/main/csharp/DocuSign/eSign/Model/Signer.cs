...
namespace DocuSign.eSign.Model
{
    ...
    /// </summary>
    [DataContract]
    public class Signer : IEquatable<Signer>
    {
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SignatureInfo != null)
                    hash = hash * 57 + this.SignatureInfo.GetHashCode();
                ...
                if (this.SignInEachLocation != null)
                    hash = hash * 57 + this.SignInEachLocation.GetHashCode();
                
                if (this.OfflineAttributes != null)
                    hash = hash * 57 + this.OfflineAttributes.GetHashCode();
                
                if (this.RequireSignerCertificate != null)
                    hash = hash * 57 + this.RequireSignerCertificate.GetHashCode();
                
                if (this.RequireSignOnPaper != null)
                    hash = hash * 57 + this.RequireSignOnPaper.GetHashCode();
                
                if (this.CanSignOffline != null)
                    hash = hash * 57 + this.CanSignOffline.GetHashCode();
                
                if (this.IsBulkRecipient != null)
                    hash = hash * 57 + this.IsBulkRecipient.GetHashCode();
                
                if (this.BulkRecipientsUri != null)
                    hash = hash * 57 + this.BulkRecipientsUri.GetHashCode();
                
                if (this.RecipientSuppliesTabs != null)
                    hash = hash * 57 + this.RecipientSuppliesTabs.GetHashCode();
