...
namespace SdkTests
{
    class TestConfig
    {
        ...
        public byte[] PrivateKeyNoConsent { get; set; }
            ...
            string returnUrl = null)
        {
            ...
            string integratorKeyNoConsentFromEnv = Environment.GetEnvironmentVariable("INTEGRATOR_KEY_JWT_NO_CONSENT");
            ...
            this.TemplateId = (templateId != null) ? templateId : templateIdFromEnv;
            ...
            this.PrivateKey = File.ReadAllBytes(pathToSolution + "private.key");
            this.ExpiresInHours = 1;

            this.EnvelopeIdsList = new List<string>();

            this.IntegratorKeyNoConsent = integratorKeyNoConsentFromEnv;
            this.PrivateKeyNoConsent = File.ReadAllBytes(pathToSolution + "privatekey_noconsent.key");
