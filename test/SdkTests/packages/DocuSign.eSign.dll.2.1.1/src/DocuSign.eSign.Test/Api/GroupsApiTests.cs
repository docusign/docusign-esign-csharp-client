...
namespace DocuSign.eSign.Test
{
    ...
    public class GroupsApiTests
    {
        ...
        public void CreateGroupsTest()
        {
            ...
            //var response = instance.CreateGroups(accountId, groupInformation);
        ...
        public void DeleteBrandsTest()
        {
            ...
            //var response = instance.DeleteBrands(accountId, groupId, brandsRequest);
        ...
        public void DeleteGroupUsersTest()
        {
            ...
            //var response = instance.DeleteGroupUsers(accountId, groupId, userInfoList);
        ...
        public void DeleteGroupsTest()
        {
            ...
            //string accountId = null;
            //GroupInformation groupInformation = null;
            //var response = instance.DeleteGroups(accountId, groupInformation);
            //Assert.IsInstanceOf<GroupInformation> (response, "response is GroupInformation");
        }
        ...
        public void ListGroupUsersTest()
        {
            ...
            //var response = instance.ListGroupUsers(accountId, groupId, count, startPosition);
            //Assert.IsInstanceOf<UsersResponse> (response, "response is UsersResponse");
        }
        ...
        public void ListGroupsTest()
        {
            ...
            //string startPosition = null;
            //var response = instance.ListGroups(accountId, count, groupName, groupType, searchText, startPosition);
            //Assert.IsInstanceOf<GroupInformation> (response, "response is GroupInformation");
        }
        ...
        public void UpdateBrandsTest()
        {
            ...
            //string groupId = null;
            //BrandsRequest brandsRequest = null;
            //var response = instance.UpdateBrands(accountId, groupId, brandsRequest);
            //Assert.IsInstanceOf<BrandsResponse> (response, "response is BrandsResponse");
        }
        ...
        public void UpdateGroupUsersTest()
        {
            ...
            //string groupId = null;
            //UserInfoList userInfoList = null;
            //var response = instance.UpdateGroupUsers(accountId, groupId, userInfoList);
            //Assert.IsInstanceOf<UsersResponse> (response, "response is UsersResponse");
        }
        ...
        public void UpdateGroupsTest()
        {
            ...
            //string accountId = null;
            //GroupInformation groupInformation = null;
            //var response = instance.UpdateGroups(accountId, groupInformation);
            //Assert.IsInstanceOf<GroupInformation> (response, "response is GroupInformation");
        }
