...
namespace DocuSign.eSign.Model
{
    ...
    public partial class FolderItemsResponse :  IEquatable<FolderItemsResponse>, IValidatableObject
    {
        ...
        public FolderItemsResponse(string EndPosition = default(string), List<FolderItem> FolderItems = default(List<FolderItem>), string NextUri = default(string), string PreviousUri = default(string), string ResultSetSize = default(string), string StartPosition = default(string), string TotalSetSize = default(string))
        {
