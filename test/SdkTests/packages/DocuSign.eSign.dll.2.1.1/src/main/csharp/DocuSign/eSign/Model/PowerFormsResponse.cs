...
namespace DocuSign.eSign.Model
{
    ...
    public partial class PowerFormsResponse :  IEquatable<PowerFormsResponse>, IValidatableObject
    {
        ...
        public PowerFormsResponse(string EndPosition = default(string), string NextUri = default(string), List<PowerForm> PowerForms = default(List<PowerForm>), string PreviousUri = default(string), string ResultSetSize = default(string), string StartPosition = default(string), string TotalSetSize = default(string))
        {
