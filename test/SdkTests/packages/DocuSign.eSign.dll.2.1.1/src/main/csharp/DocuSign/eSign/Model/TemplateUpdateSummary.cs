...
namespace DocuSign.eSign.Model
{
    ...
    public partial class TemplateUpdateSummary :  IEquatable<TemplateUpdateSummary>, IValidatableObject
    {
        ...
        public TemplateUpdateSummary(BulkEnvelopeStatus BulkEnvelopeStatus = default(BulkEnvelopeStatus), string EnvelopeId = default(string), ErrorDetails ErrorDetails = default(ErrorDetails), List<ListCustomField> ListCustomFieldUpdateResults = default(List<ListCustomField>), LockInformation LockInformation = default(LockInformation), List<RecipientUpdateResponse> RecipientUpdateResults = default(List<RecipientUpdateResponse>), Tabs TabUpdateResults = default(Tabs), List<TextCustomField> TextCustomFieldUpdateResults = default(List<TextCustomField>))
        {
