...
# **GetEnvelope**
> Envelope GetEnvelope (string accountId, string envelopeId, string advancedUpdate = null, string include = null)
...
namespace Example
{
    public class GetEnvelopeExample
    {
        public void main()
        {
            ...
            {
                // Gets the status of a envelope.
                Envelope result = apiInstance.GetEnvelope(accountId, envelopeId, advancedUpdate, include);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
> System.IO.Stream GetRecipientInitialsImage (string accountId, string envelopeId, string recipientId, string includeChrome = null)
...
namespace Example
{
    public class GetRecipientInitialsImageExample
    {
        public void main()
        {
            ...
            {
                // Gets the initials image for a user.
                System.IO.Stream result = apiInstance.GetRecipientInitialsImage(accountId, envelopeId, recipientId, includeChrome);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
> System.IO.Stream GetRecipientSignatureImage (string accountId, string envelopeId, string recipientId, string includeChrome = null)
...
namespace Example
{
    public class GetRecipientSignatureImageExample
    {
        public void main()
        {
            ...
            {
                // Retrieve signature image information for a signer/sign-in-person recipient.
                System.IO.Stream result = apiInstance.GetRecipientSignatureImage(accountId, envelopeId, recipientId, includeChrome);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
namespace Example
{
    public class GetTemplateRecipientDocumentVisibilityExample
    {
        public void main()
        {
            ...
            {
                // Returns document visibility for the recipients
                DocumentVisibilityList result = apiInstance.GetTemplateRecipientDocumentVisibility(accountId, recipientId, templateId);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
namespace Example
{
    public class ListDocumentFieldsExample
    {
        public void main()
        {
            ...
            {
                // Gets the custom document fields from an  existing envelope document.
                DocumentFieldsInformation result = apiInstance.ListDocumentFields(accountId, documentId, envelopeId);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
# **ListDocuments**
> EnvelopeDocumentsResult ListDocuments (string accountId, string envelopeId, string includeMetadata = null)
...
namespace Example
{
    public class ListDocumentsExample
    {
        public void main()
        {
            ...
            {
                // Gets a list of envelope documents.
                EnvelopeDocumentsResult result = apiInstance.ListDocuments(accountId, envelopeId, includeMetadata);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
# **ListRecipients**
> Recipients ListRecipients (string accountId, string envelopeId, string includeAnchorTabLocations = null, string includeExtended = null, string includeMetadata = null, string includeTabs = null)
...
namespace Example
{
    public class ListRecipientsExample
    {
        public void main()
        {
            ...
            {
                // Gets the status of recipients for an envelope.
                Recipients result = apiInstance.ListRecipients(accountId, envelopeId, includeAnchorTabLocations, includeExtended, includeMetadata, includeTabs);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
<a name="liststatus"></a>
# **ListStatus**
> EnvelopesInformation ListStatus (string accountId, string email = null, string fromDate = null, string startPosition = null, string toDate = null, EnvelopeIdsRequest envelopeIdsRequest = null)
...
namespace Example
{
    public class ListStatusExample
    {
        public void main()
        {
            ...
            {
                // Gets the envelope status for the specified envelopes.
                EnvelopesInformation result = apiInstance.ListStatus(accountId, email, fromDate, startPosition, toDate, envelopeIdsRequest);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
# **ListStatusChanges**
> EnvelopesInformation ListStatusChanges (string accountId, string acStatus = null, string block = null, string count = null, string customField = null, string email = null, string envelopeIds = null, string exclude = null, string folderIds = null, string folderTypes = null, string fromDate = null, string fromToStatus = null, string include = null, string intersectingFolderIds = null, string order = null, string orderBy = null, string powerformids = null, string searchText = null, string startPosition = null, string status = null, string toDate = null, string transactionIds = null, string userFilter = null, string userId = null, string userName = null)
...
namespace Example
{
    public class ListStatusChangesExample
    {
        public void main()
        {
            ...
            {
                // Gets status changes for one or more envelopes.
                EnvelopesInformation result = apiInstance.ListStatusChanges(accountId, acStatus, block, count, customField, email, envelopeIds, exclude, folderIds, folderTypes, fromDate, fromToStatus, include, intersectingFolderIds, order, orderBy, powerformids, searchText, startPosition, status, toDate, transactionIds, userFilter, userId, userName);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
<a name="listtabs"></a>
# **ListTabs**
> Tabs ListTabs (string accountId, string envelopeId, string recipientId, string includeAnchorTabLocations = null, string includeMetadata = null)
...
namespace Example
{
    public class ListTabsExample
    {
        public void main()
        {
            ...
            {
                // Gets the tabs information for a signer or sign-in-person recipient in an envelope.
                Tabs result = apiInstance.ListTabs(accountId, envelopeId, recipientId, includeAnchorTabLocations, includeMetadata);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
# **ListTemplates**
> TemplateInformation ListTemplates (string accountId, string envelopeId, string include = null)
...
namespace Example
{
    public class ListTemplatesExample
    {
        public void main()
        {
            ...
            {
                // Get List of Templates used in an Envelope
                TemplateInformation result = apiInstance.ListTemplates(accountId, envelopeId, include);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
> TemplateInformation ListTemplatesForDocument (string accountId, string documentId, string envelopeId, string include = null)
...
namespace Example
{
    public class ListTemplatesForDocumentExample
    {
        public void main()
        {
            ...
            {
                // Gets the templates associated with a document in an existing envelope.
                TemplateInformation result = apiInstance.ListTemplatesForDocument(accountId, documentId, envelopeId, include);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
namespace Example
{
    public class PutAttachmentExample
    {
        public void main()
        {
            ...
            {
                // Add an attachment to a DRAFT or IN-PROCESS envelope.
                EnvelopeAttachmentsResult result = apiInstance.PutAttachment(accountId, attachmentId, envelopeId, attachment);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
namespace Example
{
    public class PutAttachmentsExample
    {
        public void main()
        {
            ...
            {
                // Add one or more attachments to a DRAFT or IN-PROCESS envelope.
                EnvelopeAttachmentsResult result = apiInstance.PutAttachments(accountId, envelopeId, envelopeAttachmentsRequest);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
namespace Example
{
    public class RotateDocumentPageExample
    {
        public void main()
        {
            ...
            {
                // Rotates page image from an envelope for display.
                apiInstance.RotateDocumentPage(accountId, documentId, envelopeId, pageNumber, pageRequest);
            }
            catch (Exception e)
            {
...
<a name="update"></a>
# **Update**
> EnvelopeUpdateSummary Update (string accountId, string envelopeId, string advancedUpdate = null, string resendEnvelope = null, Envelope envelope = null)
...
namespace Example
{
    public class UpdateExample
    {
        public void main()
        {
            ...
            {
                // Send Draft Envelope/Void Envelope/Move/Purge Envelope/Modify draft
                EnvelopeUpdateSummary result = apiInstance.Update(accountId, envelopeId, advancedUpdate, resendEnvelope, envelope);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
# **UpdateChunkedUpload**
> ChunkedUploadResponse UpdateChunkedUpload (string accountId, string chunkedUploadId, string action = null)
...
namespace Example
{
    public class UpdateChunkedUploadExample
    {
        public void main()
        {
            ...
            {
                // Integrity-Check and Commit a ChunkedUpload, readying it for use elsewhere.
                ChunkedUploadResponse result = apiInstance.UpdateChunkedUpload(accountId, chunkedUploadId, action);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
namespace Example
{
    public class UpdateChunkedUploadPartExample
    {
        public void main()
        {
            ...
            {
                // Add a chunk, a chunk 'part', to an existing ChunkedUpload.
                ChunkedUploadResponse result = apiInstance.UpdateChunkedUploadPart(accountId, chunkedUploadId, chunkedUploadPartSeq, chunkedUploadRequest);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
namespace Example
{
    public class UpdateCustomFieldsExample
    {
        public void main()
        {
            ...
            {
                // Updates envelope custom fields in an envelope.
                CustomFields result = apiInstance.UpdateCustomFields(accountId, envelopeId, customFields);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
# **UpdateDocument**
> void UpdateDocument (string accountId, string documentId, string envelopeId, string applyDocumentFields = null)
...
namespace Example
{
    public class UpdateDocumentExample
    {
        public void main()
        {
            ...
            {
                // Adds a document to an existing draft envelope.
                apiInstance.UpdateDocument(accountId, documentId, envelopeId, applyDocumentFields);
            }
            catch (Exception e)
            {
...
namespace Example
{
    public class UpdateDocumentFieldsExample
    {
        public void main()
        {
            ...
            {
                // Updates existing custom document fields in an existing envelope document.
                DocumentFieldsInformation result = apiInstance.UpdateDocumentFields(accountId, documentId, envelopeId, documentFieldsInformation);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
# **UpdateDocuments**
> EnvelopeDocumentsResult UpdateDocuments (string accountId, string envelopeId, string applyDocumentFields = null, EnvelopeDefinition envelopeDefinition = null)
...
namespace Example
{
    public class UpdateDocumentsExample
    {
        public void main()
        {
            ...
            {
                // Adds one or more documents to an existing envelope document.
                EnvelopeDocumentsResult result = apiInstance.UpdateDocuments(accountId, envelopeId, applyDocumentFields, envelopeDefinition);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
namespace Example
{
    public class UpdateEmailSettingsExample
    {
        public void main()
        {
            ...
            {
                // Updates the email setting overrides for an envelope.
                EmailSettings result = apiInstance.UpdateEmailSettings(accountId, envelopeId, emailSettings);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
namespace Example
{
    public class UpdateLockExample
    {
        public void main()
        {
            ...
            {
                // Updates an envelope lock.
                LockInformation result = apiInstance.UpdateLock(accountId, envelopeId, lockRequest);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
namespace Example
{
    public class UpdateNotificationSettingsExample
    {
        public void main()
        {
            ...
            {
                // Sets envelope notification (Reminders/Expirations) structure for an existing envelope.
                Notification result = apiInstance.UpdateNotificationSettings(accountId, envelopeId, envelopeNotificationRequest);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
namespace Example
{
    public class UpdateRecipientDocumentVisibilityExample
    {
        public void main()
        {
            ...
            {
                // Updates document visibility for the recipients
                DocumentVisibilityList result = apiInstance.UpdateRecipientDocumentVisibility(accountId, envelopeId, recipientId, documentVisibilityList);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
# **UpdateRecipients**
> RecipientsUpdateSummary UpdateRecipients (string accountId, string envelopeId, string resendEnvelope = null, Recipients recipients = null)
...
namespace Example
{
    public class UpdateRecipientsExample
    {
        public void main()
        {
            ...
            {
                // Updates recipients in a draft envelope or corrects recipient information for an in process envelope.
                RecipientsUpdateSummary result = apiInstance.UpdateRecipients(accountId, envelopeId, resendEnvelope, recipients);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
namespace Example
{
    public class UpdateRecipientsDocumentVisibilityExample
    {
        public void main()
        {
            ...
            {
                // Updates document visibility for the recipients
                DocumentVisibilityList result = apiInstance.UpdateRecipientsDocumentVisibility(accountId, envelopeId, documentVisibilityList);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
namespace Example
{
    public class UpdateTabsExample
    {
        public void main()
        {
            ...
            {
                // Updates the tabs for a recipient.  
                Tabs result = apiInstance.UpdateTabs(accountId, envelopeId, recipientId, tabs);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
namespace Example
{
    public class UpdateTemplateRecipientDocumentVisibilityExample
    {
        public void main()
        {
            ...
            {
                // Updates document visibility for the recipients
                TemplateDocumentVisibilityList result = apiInstance.UpdateTemplateRecipientDocumentVisibility(accountId, recipientId, templateId, templateDocumentVisibilityList);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
namespace Example
{
    public class UpdateTemplateRecipientsDocumentVisibilityExample
    {
        public void main()
        {
            ...
            {
                // Updates document visibility for the recipients
                TemplateDocumentVisibilityList result = apiInstance.UpdateTemplateRecipientsDocumentVisibility(accountId, templateId, templateDocumentVisibilityList);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
